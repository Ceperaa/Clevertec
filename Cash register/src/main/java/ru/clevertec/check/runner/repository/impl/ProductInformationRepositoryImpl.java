...
public class ProductInformationRepositoryImpl extends RepositoryEntityImpl<ProductInformation> {
    ...
    @Override
    public List<ProductInformation> findAll() throws Exception {
        return (List) productInformationIo.importServiceFile();
    }

    @Override
    public ProductInformation add(ProductInformation o) throws Exception {
        increment++;
        o.setId(increment);
        map.put(o.getId(), o);
    ...
    @Override
    public ProductInformation update(ProductInformation productInformation) throws Exception {
