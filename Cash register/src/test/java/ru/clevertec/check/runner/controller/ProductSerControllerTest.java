...
class ProductSerControllerTest implements ControllerTest {

    private final MockMvc mvc;
    private final ObjectMapper objectMapper;

    @Autowired
    ProductSerControllerTest(MockMvc mvc, ObjectMapper objectMapper) {
        this.mvc = mvc;
    ...
    void add() throws Exception {
        mvc.perform(MockMvcRequestBuilders.put("/product/add")
                .content(objectMapper.writeValueAsString(ProductDtoForSave
                        .builder()
                        //.id(1L)
                        .amount("1")
                        .name("Apple")
