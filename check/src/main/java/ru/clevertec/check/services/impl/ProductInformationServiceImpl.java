...
import ru.clevertec.check.repository.ProductInformationRepository;
...
import ru.clevertec.check.util.mapperMapstruct.ProductInformationMapper;
...
public class ProductInformationServiceImpl implements ProductInformationService {
    ...
    public double discountСalculation(
            List<ProductInformation> productList, double total, Long idCard) throws ObjectNotFoundException {
        if (idCard != null) {
