...
import ru.clevertec.check.services.ProductInformationService;
import ru.clevertec.check.services.ProductService;
import ru.clevertec.check.util.exception.ObjectNotFoundException;
import ru.clevertec.check.util.mapper.PdfMapper;
import ru.clevertec.check.util.mapperMapstruct.CheckMapper;
...
public class CheckRunnerServiceImpl implements CheckRunnerService {
    ...
    @Transactional
    public CheckDto createCheck(List<String> itemIdQuantity, Long idCard,OutputStream outputStream)
        ...
        checkMapToPdf(checkDto,outputStream);
        return checkDto;
    }
